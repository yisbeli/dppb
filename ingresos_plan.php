		...
		<div class="rows">
			...
			<div class="col-md-8">
				...
				<div class="buttons text-center">
					<imput class="btn btn-sistema" type="button" onclick=location="sala.php">Regresar al menu</button>		
				</div><br>

				<div class="buttons text-center">
			<input class="btn btn-sistema" type="button" class="submit" name="entrar" id="submit" value="Regresar al Inicio" onclick=location="sala.php" align="center" />
			</div>
