...
<form method="post" action="modificar_pac2.php">
     ...
     <input class="form-control" type="number" name="cedu_pac" value="<?php echo $row['cedu_pac']; ?>"   id="cedu_pac"  placeholder="Ingrese  solo caracteres numericos " required />
     </div>
	
     <div class="col-md-6">
    <label for="nomb_pac"> Nombre:</label>
    <input class="form-control" type="text" name="nomb_pac" value="<?php echo $row['cedu_pac'];?>" id="nomb_pac" placeholder="Ingrese nombre del paciente" required/>
     </div>
