				...
				<div id="cuerpo">
						...
						<form method="post" action="insert_resp.php">
							...
							<label for="ced_resp">Cédula: </label>
								<select name="nacionalidad" class="nac">
									<option name="nacionalidad" value="V"> V </option>
									<option name="nacionalidad" value="E"> E </option>
								</select>
							<label class="guion"> - </label>
								<input id="text_form" type="text" class="cedula" name="ced_resp" maxlength="8" size="6" placeholder="00000000" requi patter="^\d{8}" title="Ejemplo: V-00000000" /><br />
