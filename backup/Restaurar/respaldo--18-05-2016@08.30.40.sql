...
CREATE TABLE `egresos` (
  `cod_egr` int(11) NOT NULL AUTO_INCREMENT COMMENT 'C骴igo de Egreso',
...
INSERT INTO `egresos`  VALUES ( "2","2015-10-02","Compra de lap韟","100.2","789456");
...
CREATE TABLE `expediente` (
  ...
  `cod_part` int(11) NOT NULL COMMENT 'C骴igo de Participante',
  PRIMARY KEY (`cod_exp`),
...
CREATE TABLE `nivel_academico` (
  `id_nivel` int(2) NOT NULL AUTO_INCREMENT COMMENT 'C骴igo de nivel Academico',
...
INSERT INTO `nivel_academico`  VALUES ( "8","T閏nico medio");
...
CREATE TABLE `paciente` (
  `cedu_pac` int(11) NOT NULL COMMENT 'C閐ula del Paciente',
  ...
  `cod_serv` int(11) NOT NULL COMMENT 'C骴igo de Servicio',
...
CREATE TABLE `participantes` (
  `cod_par` int(11) NOT NULL AUTO_INCREMENT COMMENT 'C骴igo de Participantes',
  `ced_part` int(11) NOT NULL COMMENT 'C閐ula de Participante',
  ...
  `profe_part` char(15) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL COMMENT 'Profesi髇 de Participante',
  `tlfn_part` char(12) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL COMMENT 'Tel閒ono de Participante',
  `email_part` char(25) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL COMMENT 'Email de Participante',
  `id_nivel` int(11) NOT NULL COMMENT 'C骴igo Nivel Academico',
...
INSERT INTO `participantes`  VALUES ( "4","19539526","Yuriesskys","Rojas","docente","678909887654","yuriesskys.rojas@gmail.co","10","V","Sim贸n Rodriguez");
...
INSERT INTO `participantes`  VALUES ( "21","25678890","Johana","Felisola","docente","0215-5354890","johana_felisola@gmail.com","10","V","Sim贸n Rodriguez");
...
CREATE TABLE `planes` (
  `cod_plan` int(11) NOT NULL AUTO_INCREMENT COMMENT 'C骴igo de Planes',
  ...
  `desc_plan` varchar(250) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL COMMENT 'Descripci髇 del Plan ',
  `cant_unid` int(2) NOT NULL COMMENT 'Cantidad de U.T a cancelar',
  `id_unid` int(11) DEFAULT NULL COMMENT 'C骴igo de la Unidad Tributaria',
  PRIMARY KEY (`cod_plan`),
  KEY `id_unid` (`id_unid`),
  KEY `tipo_plan` (`tipo_plan`)
) ENGINE=InnoDB AUTO_INCREMENT=10 DEFAULT CHARSET=utf8 COLLATE=utf8_spanish_ci;

INSERT INTO `planes`  VALUES ( "2","1","Evacuaci髇 de terremotos","Retiro de personas en lugares cerrados","0","2");
INSERT INTO `planes`  VALUES ( "3","1","Atenci髇 de parto","Parto vaginal espont醤eo, Parto abdominal","0","2");
INSERT INTO `planes`  VALUES ( "4","2","RCP","La reanimaci髇 cardiopulmonar(RCP) es un procedimiento de emergencia para salvar vidas que se utiliza cuando una persona ha dejado de respirar y el coraz贸n ha cesado de palpitar.","2","2");
INSERT INTO `planes`  VALUES ( "5","2","Primero auxilios","Atenci髇 inmediata que se le da a una persona enferma o lesionada en el lugar de los acontecimientos","3","2");
INSERT INTO `planes`  VALUES ( "6","3","Manejo de Fuegos Artificiales","La forma m醩 segura de prevenir las lesiones relacionadas con los fuegos artificiales es dejando el uso de estos a profesionales que han recibido entrenamiento..","0","2");
INSERT INTO `planes`  VALUES ( "7","3","Incendios forestales","Un incendio forestal se distingue de otros tipos de incendio por su amplia extensi贸n, la velocidad con la que se puede extender desde su lugar de origen, su potencial para cambiar de direcci贸n inesperadamente, y su capacidad para superar obst谩culo","0","2");
INSERT INTO `planes`  VALUES ( "8","4","Atenci髇 pre-hospitalaria  ","Introducci髇, Objetivos, Precauciones ","4","3");
INSERT INTO `planes`  VALUES ( "9","5","telefono","gt i9192","4","3");
...
INSERT INTO `planes_participantes`  VALUES ( "11","7","6","","0","inscrito","No","2147483647");
INSERT INTO `planes_participantes`  VALUES ( "12","5","7","","450","inscrito","No","2147483647");
INSERT INTO `planes_participantes`  VALUES ( "14","5","3","","450","inscrito","No","23456789");
INSERT INTO `planes_participantes`  VALUES ( "15","3","3","12","0","inscrito","Si","0");
INSERT INTO `planes_participantes`  VALUES ( "16","5","8","","450","inscrito","Si","0");
INSERT INTO `planes_participantes`  VALUES ( "20","3","12","20","300","inscrito","No","12345420");
INSERT INTO `planes_participantes`  VALUES ( "24","4","16","","300","inscrito","Si","0");
INSERT INTO `planes_participantes`  VALUES ( "26","9","18","","0","inscrito","No","2147483647");
...
INSERT INTO `planes_participantes`  VALUES ( "30","5","19","","0","inscrito","No","908978654");
INSERT INTO `planes_participantes`  VALUES ( "31","5","19","","0","inscrito","No","908978654");
INSERT INTO `planes_participantes`  VALUES ( "32","5","20","","0","pre-inscrito","No","");
INSERT INTO `planes_participantes`  VALUES ( "33","6","21","","0","pre-inscrito","No","");
INSERT INTO `planes_participantes`  VALUES ( "34","16","22","","600","pre-inscrito","No","");
INSERT INTO `planes_participantes`  VALUES ( "35","7","23","","0","inscrito","No","2147483647");
INSERT INTO `planes_participantes`  VALUES ( "36","7","24","","0","pre-inscrito","No","");
INSERT INTO `planes_participantes`  VALUES ( "37","18","24","","300","inscrito","No","2147483647");
...
CREATE TABLE `planes_responsables` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `cod_plan` int(11) NOT NULL COMMENT 'C骴igo de Plan ',
  `cod_resp` int(11) NOT NULL COMMENT 'C骴igo de Responsable',
...
CREATE TABLE `responsables` (
  `cod_resp` int(11) NOT NULL AUTO_INCREMENT COMMENT 'C骴igo Responsable',
  `ced_resp` int(8) NOT NULL COMMENT 'C閐ula Responsable',
  ...
  `id_tipo` int(11) NOT NULL COMMENT 'C骴igo de Tipo de Responsable',
...
INSERT INTO `responsables`  VALUES ( "11","20435525","beth","newman","urologo","8","4");
INSERT INTO `responsables`  VALUES ( "12","6861943","belkis ","soto","jkhgfdse","13","1");
...
CREATE TABLE `servicios` (
  `cod_serv` int(11) NOT NULL AUTO_INCREMENT COMMENT 'C骴igo de Servicio ',
  ...
  `direc_salida` varchar(50) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL COMMENT 'Direcci髇 salida de la Ambulacia ',
  `direc_destino` varchar(50) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL COMMENT 'Direcci髇 de Destino de la Ambulancia',
  `id_tipo_serv` int(11) NOT NULL COMMENT 'C骴igo de Tipo de Servicio  ',
  `id_unidad` int(11) NOT NULL COMMENT 'C骴igo del Vehiculo',
  `id_municipio` int(11) NOT NULL COMMENT 'C骴igo de Municipio',
  `cod_resp` int(11) NOT NULL COMMENT 'C骴igo de Responsable ',
...
INSERT INTO `tipo_plan`  VALUES ( "5","samsung","si");
...
CREATE TABLE `tipo_servicio` (
  `id_tipo_serv` int(11) NOT NULL AUTO_INCREMENT COMMENT 'C骴igo de Tipo de Servicio',
...
INSERT INTO `tipo_servicio`  VALUES ( "1","Traslado");
...
INSERT INTO `tipos_resp`  VALUES ( "6","cuidador");
...
CREATE TABLE `unidades` (
  `id_unidad` int(2) NOT NULL AUTO_INCREMENT COMMENT 'C骴igo del Veh韈ulo  ',
  ...
  `estacion` varchar(20) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL COMMENT 'Estaci髇 a la que pertenece el Vehiculo',
...
CREATE TABLE `unidades_trib` (
  `id_unid` int(11) NOT NULL AUTO_INCREMENT COMMENT 'C骴igo de la UT',
